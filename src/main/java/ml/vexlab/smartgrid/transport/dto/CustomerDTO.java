...
public class CustomerDTO {
	...
	public CustomerDTO(String id, String title, String description, String country, String city, String state,
			String postalCode, String address, String phone, String email) {
		super();
		this.id = id;
		this.title = title;
		this.description = description;
