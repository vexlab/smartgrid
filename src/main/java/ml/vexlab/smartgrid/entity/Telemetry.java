...
public abstract class Telemetry {
	...
	@Column
	protected Boolean bool_value;

	@Column
	protected String str_value;

	@Column
	protected Integer int_value;

	@Column
	protected Double dbl_value;
	...
	public Telemetry(String key, Boolean bool_value, String str_value, Integer int_value, Double dbl_value) {
		super();
		this.key = key;
		this.bool_value = bool_value;
		this.str_value = str_value;
